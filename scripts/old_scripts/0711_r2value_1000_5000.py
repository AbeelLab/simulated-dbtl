...
results2000=pd.DataFrame(results6)
results5000=pd.DataFrame(results7)
...
results2000=results2000.iloc[:,[3,1,2,6,0,5,4,7]]
results5000=results5000.iloc[:,[3,1,2,6,0,5,4,7]]


results50.to_csv("../results/no_noise_scenario_analysis/sc1_nonoise_50_3110.csv")
results100.to_csv("../results/no_noise_scenario_analysis/sc1_nonoise_100_3110.csv")
...
results2000.to_csv("../results/no_noise_scenario_analysis/sc1_nonoise_2000_3110.csv")
results5000.to_csv("../results/no_noise_scenario_analysis/sc1_nonoise_5000_3110.csv")
